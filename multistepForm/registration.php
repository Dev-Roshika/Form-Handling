        ...
        ?>
            ...
            <form action="registration.php" method="post">
                <div style="width: 30em;">
                    ...
                    <input type="text" name="firstName" id="firstName" value="<?php setValue( "firstName" ) ?>" /> <br><br>
                    
                    <label for="lastName"<?php validateField( "lastName", $missingFields ) ?>>Last name *</label>
                    <input type="text" name="lastName" id="lastName" value="<?php setValue( "lastName" ) ?>" /><br><br>
                    ...
                    <label<?php validateField( "gender", $missingFields ) ?>>Your gender: *</label><br><br>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <label for="genderMale">Male</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="gender" id="genderMale" value="M"<?php setChecked( "gender", "M" )?>/><br><br>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <label for="genderFemale">Female</label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="gender" id="genderFemale" value="F"<?php setChecked( "gender", "F" )?> /><br><br>
